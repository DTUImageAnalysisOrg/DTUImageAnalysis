...
here a new virtual environment called `imageanalysis` is created and activated. If you want more details on how setup environments there is a guide from [Python support](https://pythonsupport.dtu.dk/learn-more/packages-and-environments/environments.html). 
...
Please see [Figures in Notebooks](figs_in_nbs.md) for details on figures in notebooks.
