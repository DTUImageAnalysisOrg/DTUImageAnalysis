...
??? tip "Solution 3"
    ...
    ```
    Greater covariance between sepal length and sepal width than sepal length and petal length.
<!-- END_SOLUTION 3 -->
...
??? tip "Solution 5"
    ...
    np.allclose(c_x, c_x_np) # Check if the two matrices are equal.
    ```
<!-- END_SOLUTION 5 -->
...
??? tip "Solution 13"
    - [ ] Features=25, observations = 423
    - [x] Features=30, observations=569
    - [ ] Features=41, observations=714
    - [ ] Do not know
    - [ ] Features=17, observations=265
    - [ ] Features=47, observations=435
